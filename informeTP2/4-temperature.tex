...
Este es el último paso. Debemos quedarnos con las valores según valfa \emph{T}, Son todas operaciones lógicas y de comparaciones. Solo debemos recordar q en xmm4, xmm5, xmm6, xmm7 y xmm3 están los casos T.
